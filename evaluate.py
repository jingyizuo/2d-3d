...
parser.add_argument("--test_picture_path", default="./input/test/", help="path of test datas.")#网络测试输入的图片路径
parser.add_argument("--test_label_path", default="./label/test/", help="path of test datas.") #网络测试输入的标签路径
parser.add_argument("--image_size", type=int, default=256, help="load image size") #网络输入的尺度
parser.add_argument("--test_picture_format", default='.tif', help="format of test pictures.") #网络测试输入的图片的格式
parser.add_argument("--test_label_format", default='.tif', help="format of test labels.") #网络测试时读取的标签的格式
